...
#define KEYPAD_ROW0 DIO_D0
#define KEYPAD_ROW1 DIO_D1
#define KEYPAD_ROW2 DIO_D2
#define KEYPAD_ROW3 DIO_D3

#define KEYPAD_COL0 DIO_D4
#define KEYPAD_COL1 DIO_D5
#define KEYPAD_COL2 DIO_D6
#define KEYPAD_COL3 DIO_D7
